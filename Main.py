...
def assignDealer(parTableList, parEmployeeList):
    ...
    for tble in parTableList:
        for emp in parEmployeeList:
            tble.dealerOut, tble.dealerName = emp.canDeal(tble.gameCode, tble.dealerOut, tble.dealerName)
...
#
#                 for dlrN in range(len(parTableList[k].dealerOut)):
#                     if parEmployeeList[x].startTime in parTableList[k].dealerOut[v] and parTableList[k].gameCode in parEmployeeList[x].gamesKnown:
...
#                 if parEmployeeList[x].name not in parTableList[k].dealerName:
